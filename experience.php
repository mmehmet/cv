...
const DESC = [
    ...
    TP => 'Heading up one of the dev teams, including running a team of (overseas) remote devs. Encouraging test-driven development as well as modern Best Practices and coding standards. Creating many projects from scratch, working within a mix of environments including CMS environments provided by clients. Delivering Docker images for containerised deployments of TypeScript/NodeJS back end applications or custom-built CMS packages or sometimes entirely self-contained micro-sites, with a complete CI/CD solution from first git commit to fully functioning Production application running on scalable AWS/Azure infrastructure. Providing technical consultation on client briefs, including scoping and assessment of available resources.',
